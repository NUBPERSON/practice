...
var _workbook = _interopRequireDefault(require("./statics/workbook.xml"));

var _workbookXml = _interopRequireDefault(require("./statics/workbook.xml.rels"));

var _rels = _interopRequireDefault(require("./statics/rels"));

var _Content_Types = _interopRequireDefault(require("./statics/[Content_Types].xml"));

var _writeXlsxFile = require("./writeXlsxFile.common");
...
function generateXlsxFile(data, _ref2) {
  ...
  var _generateSheets = (0, _writeXlsxFile.generateSheets)({
    data: data,
  ...
  xl.file('_rels/workbook.xml.rels', (0, _workbookXml["default"])({
    sheets: sheets
  }));
  xl.file('workbook.xml', (0, _workbook["default"])({
    sheets: sheets
  }));
